...
# @param[in]  robot  De robot die getekent moet worden
#  More details.
...
## Documentation for loop random rond
# Hij rijdt random rond
def loopRandomRond():
...
## Documentation for a function.
# @param[in]  ignorePlant  Mag genegeerd worden haha
#  More details.
...
def movePlantToSafePlace(plant):
    safe = False
    while not safe:
